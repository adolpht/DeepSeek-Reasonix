...
// SetGate installs the per-call permission gate. Used by `Rexion chat` to swap the
...
// `Rexion chat --resume` to load a saved JSONL transcript before the first turn,
