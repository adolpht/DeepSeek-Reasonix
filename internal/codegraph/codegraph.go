...
// than shipped in the Rexion binary, which keeps installs small. Resolve finds
...
// BundleDirName is the directory, beside the Rexion executable, that the release
...
//  4. a bundle placed beside the Rexion executable (fallback for manual setups).
//
...
// bundled looks for the CodeGraph launcher unpacked beside the Rexion binary.
