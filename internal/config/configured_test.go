...
func TestProviderConfigured(t *testing.T) {
	...
	cases := []struct {
		...
		{"key set", ProviderEntry{APIKeyEnv: "REXION_TEST_KEY"}, true},
		{"key env empty", ProviderEntry{APIKeyEnv: "REXION_TEST_EMPTY"}, false},
		{"key env unset", ProviderEntry{APIKeyEnv: "REXION_TEST_MISSING"}, false},
