# Contributing to Rexion

Thank you for your interest in contributing to Rexion! This guide covers
...
```bash
git clone https://github.com/esengine/DeepSeek-Rexion.git
cd DeepSeek-Rexion
go build ./cmd/Rexion    # builds the CLI binary
...
| `internal/memory` | Rexion.md hierarchy + auto-memory |
