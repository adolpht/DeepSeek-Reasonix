...
const DM = "__Rexion_MATH_DISPLAY__";
const IM = "__Rexion_MATH_INLINE__";
const LB = "__Rexion_LATEX_LINEBREAK__";
const DOLLAR = "&#36;";
...
function unusedPlaceholderPrefix(s: string): string {
  let prefix = "__Rexion_PROTECTED_CODE__";
  let n = 0;
  while (s.includes(prefix)) {
    n += 1;
    prefix = `__Rexion_PROTECTED_CODE_${n}__`;
  }
  return prefix;
}
