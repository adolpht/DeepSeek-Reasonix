...
STANDALONE_PLUGINS_SRC := rexon-plugin-slides rexon-plugin-search rexon-plugin-browser rexon-plugin-design rexon-plugin-computer
STANDALONE_PLUGINS_OUT := rexion-plugin-slides rexion-plugin-search rexion-plugin-browser rexion-plugin-design rexion-plugin-computer
