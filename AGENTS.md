...
| `internal/skill` | Playbook loader from Markdown. Scopes: project > custom > global > builtin. Convention dirs: `.rexion`, `.agents`, `.agent`, `.Codex` |
...
Skills and instructions are discovered from multiple convention directories: `.rexion`, `.agents`, `.agent`, `.Codex` — under both the project root and home dir. This allows skills authored for other agent tools to migrate in unchanged.
