...
func main() {
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(), "e2ebench — Rexion end-to-end benchmark.\n\n")
	...
	bin := flag.String("bin", "Rexion", "path to the Rexion binary")
...
func render(results []result) string {
	...
	fmt.Fprintf(&b, "## 🤖 Rexion e2e benchmark\n\n")
