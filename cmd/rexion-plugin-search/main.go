// Command Rexion-plugin-search is an MCP stdio server exposing web search,
// web page extraction, and comparison table tools to Rexion. It is a standalone
// binary wired in via Rexion.toml:
//
//	[[plugins]]
//	name    = "search"
//	command = "Rexion-plugin-search"
//
// Rexion then surfaces its tools as mcp__search__web_search / web_extract /
...
func main() {
	log.SetPrefix("Rexion-plugin-search: ")
	log.SetFlags(0)
...
// --- JSON-RPC framing (mirrors Rexion-plugin-office / -sheet) ---
...
func handleLine(line []byte, w *bufio.Writer) error {
	...
	case "initialize":
		resp.Result = map[string]any{
			...
			"serverInfo":      map[string]any{"name": "Rexion-plugin-search", "version": version},
		}
	case "tools/list":
