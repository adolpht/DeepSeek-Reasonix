...
agent. It is the Rexion analog of Claude Code's CLAUDE.md.
...
- Hierarchical docs: `Rexion.md` (this file, committed/shared), `Rexion.local.md`
  (personal, git-ignored), user-global `~/.config/Rexion/Rexion.md`, and any
  `Rexion.md` in an ancestor dir. `AGENTS.md` is accepted as a fallback name.
